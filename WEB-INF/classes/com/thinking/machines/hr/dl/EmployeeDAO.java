...
public class EmployeeDAO {
    ...
    public void update(EmployeeDTO employee) throws DAOException {
        try {
            ...
            String panNumber = employee.getPanNumber();
            String aadharCardNumber = employee.getAadharCardNumber();
            preparedStatement = connection.prepareStatement("select id from employee where pan_number=? and id<>?");//<> is equivalant to != in sql
            preparedStatement.setString(1, panNumber);
    ...
    public EmployeeDTO getByPanNumber(String panNumber) throws DAOException {
        ...
        try {
            ...
            BigDecimal basicSalary;
            String aadharCardNumber;
            actualEmployeeId = resultSet.getInt("id");
